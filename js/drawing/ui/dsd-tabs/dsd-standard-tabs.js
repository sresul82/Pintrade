    ...
    if (caps.capArrows) {
      ...
      html += `
          <div class="dsd-cap-drop" style="position:relative;margin-right:4px;">
            <div class="dsd-cap-drop-btn" data-side="left" style="display:flex;align-items:center;gap:6px;background:#131722;border:1px solid #7d808b;border-radius:4px;height:30px;padding:0 8px;cursor:pointer;color:#d1d4dc;">
          ...
          <div class="dsd-cap-drop" style="position:relative;">
            <div class="dsd-cap-drop-btn" data-side="right" style="display:flex;align-items:center;gap:6px;background:#131722;border:1px solid #7d808b;border-radius:4px;height:30px;padding:0 8px;cursor:pointer;color:#d1d4dc;">
  ...
  function renderTextTab(d) {
    ...
    return `
      ...
      <div class="dsd-row" style="margin-bottom:16px;">
        <textarea class="dsd-textarea" id="dsd-text" placeholder="Add text" style="min-height:140px; border-radius:6px; border:1px solid #7d808b; background:#131722; color:#d1d4dc; padding:8px;">${text}</textarea>
      </div>
