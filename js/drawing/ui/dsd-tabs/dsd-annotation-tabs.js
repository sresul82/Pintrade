    ...
    if (isCallout) {
      ...
      return `
        ...
        <div style="display:flex; align-items:center; margin-bottom:16px;">
          ...
          <div style="display:flex; align-items:center; border:1px solid #4a4f5e; border-radius:4px; overflow:hidden; flex-shrink:0;">
            <div class="dsd-color-swatch js-callout-border"
                 data-color="${borderColor}" style="background-color:${borderColor}; border-right:1px solid #4a4f5e; border-radius:0;"></div>
