...
window.PropertyToolbar = (() => {
  ...
  function _openAdvancedPicker(baseHex, onOk) {
    ...
    el.id = 'pt-adv-picker';
    el.style.cssText = `position:fixed;z-index:100000;background:#1e222d;border:1px solid #363c4e;border-radius:6px;padding:12px;box-shadow:0 8px 24px rgba(0,0,0,0.6);width:200px;`;
    el.innerHTML = `
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;">
        <div id="ap-preview" style="width:24px;height:24px;background:${baseHex};border:1px solid #363c4e;border-radius:4px;flex-shrink:0;"></div>
      ...
      <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:12px;padding-top:10px;border-top:1px solid #2a2e39;">
        <button id="ap-cancel" style="background:transparent;border:1px solid #363c4e;color:#d1d4dc;padding:5px 14px;border-radius:4px;cursor:pointer;font-size:12px;">Cancel</button>
  ...
  function _openColorMenu(anchorEl, currentColor, onSelect) {
    ...
    const el = document.createElement('div');
    el.style.cssText = `position:fixed;z-index:50000;background:#1e222d;border:1px solid #363c4e;border-radius:6px;padding:10px;box-shadow:0 6px 20px rgba(0,0,0,0.5);width:242px;`;
    ...
    el.innerHTML = `
      ...
      <div style="display:flex;align-items:center;gap:2px;flex-wrap:wrap;">
        ${neonRow}
        <div id="pt-add-custom" style="width:18px;height:18px;border-radius:2px;cursor:pointer;border:1px solid #363c4e;display:flex;align-items:center;justify-content:center;color:#787b86;">
      ...
      <div style="margin-top:4px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">
          ...
          <span id="pt-op-val" style="font-size:11px;color:#d1d4dc;background:#131722;border:1px solid #363c4e;padding:2px 6px;border-radius:3px;min-width:38px;text-align:center;">${baseOp}%</span>
        </div>
  ...
  function _openWidthMenu(anchorEl, currentWidth, onSelect) {
    ...
    const el = document.createElement('div');
    el.style.cssText = `position:fixed;z-index:50000;background:#1e222d;border:1px solid #363c4e;border-radius:6px;padding:4px 0;box-shadow:0 6px 20px rgba(0,0,0,0.5);min-width:100px;`;
  ...
  function _openFontSizeMenu(anchorEl, currentSize, onSelect) {
    ...
    const el = document.createElement('div');
    el.style.cssText = `position:fixed;z-index:50000;background:#1e222d;border:1px solid #363c4e;border-radius:6px;padding:4px 0;box-shadow:0 6px 20px rgba(0,0,0,0.5);min-width:60px;max-height:200px;overflow-y:auto;`;
  ...
  function _openStyleMenu(anchorEl, currentStyle, onSelect) {
    ...
    const el = document.createElement('div');
    el.style.cssText = `position:fixed;z-index:50000;background:#1e222d;border:1px solid #363c4e;border-radius:6px;padding:4px 0;box-shadow:0 6px 20px rgba(0,0,0,0.5);min-width:130px;`;
